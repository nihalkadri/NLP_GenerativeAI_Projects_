...
def load_and_display_dataset_details():
    emotion_dataset = load_dataset('csv', data_files={'train': r"PATH_TRAIN_DATA_CSV", 'test': r"PATH_TEST_DATA_CSV",
                                                      'val': r"PATH_VAL_DATA_CSV"})
    ...
    emotion_val = emotion_dataset['val']
